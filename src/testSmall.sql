...
create index board_index_gin on chessgame_table USING GIN (p_chessgame);
...
SELECT *
FROM chessgame_table
WHERE has_board(p_chessgame,'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkqmonenormefiak - 0 1', 2);
