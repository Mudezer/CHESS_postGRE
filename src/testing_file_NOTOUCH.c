...
void test_getFirstMoves() {
    ...
    // select getFirstMoves('1. e4 e5 2. Bc4 Nf6', 1);
    // select getFirstMoves('1. e4 e5 2. Bc4 Nf6', 2);
    // select getFirstMoves('1. e4 e5 2. Bc4 Nf6', 3);
    // select getFirstMoves('1. e4 e5 2. Bc4 Nf6', 4);
...
void test_hasOpening() {
    ...
    // select hasOpening('1. e4 c5 2. Nf3 d6 3. d4 cxd4'::chessgame, '1. e4 c5 2. Nf3 d6'::chessgame);
    // select hasOpening('1. e4 c5 2. Nf3 d6 3. d4 cxd4', '1. e4 c5 2. Nf3 d6'); //idem sans cast
    // select hasOpening('1. e4 c5 2. Nf3 d6 3. d4 cxd4'::chessgame, '1. e4 c5'::chessgame);
    // select hasOpening('1. e4 c5 2. Nf3 d6 3. d4 cxd4'::chessgame, '1. e4 c3'::chessgame);
...
void test_hasBoard() {
    ...
    // select Board('1. e4 c5 2. Nf3 d6 3. d4 cxd4 4. Nxd4 Nf6 5. Nc3 Nc6 6. Bc4 e6 7. Be3 Be7 8. Bb3 O-O 9. Qe2 Qa5 10. O-O-O Nxd4 11. Bxd4 Bd7 12. Kb1 Bc6 13. f4 Rad8 14. Rhf1 b5 15. f5 b4 16. fxe6 bxc3 17. exf7+ Kh8 18. Rf5 Qb4 19. Qf1 Nxe4 20. a3 Qb7 21. Qf4 Ba4 22. Qg4 Bf6 23. Rxf6 Bxb3', '3r1r1k/pq3Ppp/3p1R2/8/3Bn1Q1/Pbp5/1PP3PP/1K1R4 w - - 0 24', 46);
...
void test_getBoard() {
    ...
    // select getBoard('1. e4 c5 2. Nf3 d6 3. d4 cxd4 4. Nxd4 Nf6 5. Nc3 Nc6 6. Bc4 e6 7. Be3 Be7 8. Bb3 O-O 9. Qe2 Qa5 10. O-O-O Nxd4 11. Bxd4 Bd7 12. Kb1 Bc6 13. f4 Rad8 14. Rhf1 b5 15. f5 b4 16. fxe6 bxc3 17. exf7+ Kh8 18. Rf5 Qb4 19. Qf1 Nxe4 20. a3 Qb7 21. Qf4 Ba4 22. Qg4 Bf6 23. Rxf6 Bxb3', 4);
